...
st.title("🛠️ Plateforme LLM+Tools (Azure/OPENAI tool-calling natif)")
...
# ---- 4. Sidebar tools : upload, suppression, test ----
...
# ---- 5. Tool-calling natif (Azure/OpenAI) ----
def call_llm(messages: List[Dict], tools: Dict[str, Any]=None) -> Dict:
    ...
    for tname, tinfo in (tools or {}).items():
        ...
        tool_defs.append({
            "type": "function",  # <- INDISPENSABLE pour Azure/OpenAI !
